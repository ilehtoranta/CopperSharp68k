...
public static class Exec
{
	...
	public static extern uint FindResident(
		[M68kRegister(M68kRegister.A1)] uint name);
	...
	public static extern sbyte OpenDevice(
		[M68kRegister(M68kRegister.A0)] uint deviceName,
	...
	public static extern uint OpenResource(
		[M68kRegister(M68kRegister.A1)] uint resourceName);

	[AmigaLvo(-522)]
	public static extern void RawDoFmt(
		[M68kRegister(M68kRegister.A0)] uint formatString,
