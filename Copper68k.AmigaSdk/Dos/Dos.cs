...
public static class Dos
{
	...
	public static extern int Rename(
		[M68kRegister(M68kRegister.D1)] uint oldName,
		[M68kRegister(M68kRegister.D2)] uint newName);
	...
	public static extern int SetComment(
		[M68kRegister(M68kRegister.D1)] uint name,
		[M68kRegister(M68kRegister.D2)] uint comment);
	...
	public static extern int Execute(
		[M68kRegister(M68kRegister.D1)] uint command,
	...
	public static extern int FPuts(
		[M68kRegister(M68kRegister.D1)] uint file,
		[M68kRegister(M68kRegister.D2)] uint text);

	[AmigaLvo(-348)]
	public static extern void VFWritef(
		[M68kRegister(M68kRegister.D1)] uint file,
		[M68kRegister(M68kRegister.D2)] uint format,
	...
	public static extern int ReadLink(
		...
		[M68kRegister(M68kRegister.D3)] uint path,
	...
	public static extern int Fault(
		...
		[M68kRegister(M68kRegister.D2)] uint header,
		[M68kRegister(M68kRegister.D3)] uint buffer,
	...
	public static extern int SetArgStr(
		[M68kRegister(M68kRegister.D1)] uint text);
	...
	public static extern int AssignLate(
		[M68kRegister(M68kRegister.D1)] uint name,
		[M68kRegister(M68kRegister.D2)] uint path);
	...
	public static extern uint FindDosEntry(
		[M68kRegister(M68kRegister.D1)] uint dosList,
		[M68kRegister(M68kRegister.D2)] uint name,
	...
	public static extern int Format(
		[M68kRegister(M68kRegister.D1)] uint fileSystem,
		[M68kRegister(M68kRegister.D2)] uint volumeName,
		[M68kRegister(M68kRegister.D3)] uint dosType);

	[AmigaLvo(-720)]
	[return: M68kRegister(M68kRegister.D0)]
	public static extern int Relabel(
		[M68kRegister(M68kRegister.D1)] uint drive,
		[M68kRegister(M68kRegister.D2)] uint newName);
	...
	public static extern uint ReadArgs(
		[M68kRegister(M68kRegister.D1)] uint template_,
	...
	public static extern int FindArg(
		[M68kRegister(M68kRegister.D1)] uint keyword,
		[M68kRegister(M68kRegister.D2)] uint template_);
	...
	public static extern int MatchFirst(
		[M68kRegister(M68kRegister.D1)] uint pattern,
	...
	public static extern uint FilePart(
		[M68kRegister(M68kRegister.D1)] uint path);
	...
	public static extern int AddPart(
		[M68kRegister(M68kRegister.D1)] uint directoryName,
		[M68kRegister(M68kRegister.D2)] uint fileName,
	...
	public static extern int VPrintf(
		[M68kRegister(M68kRegister.D1)] uint format,
	...
	public static extern int GetFileSysAttr(
		[M68kRegister(M68kRegister.D1)] uint deviceName,
