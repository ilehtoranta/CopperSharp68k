...
public static class MuiMaster
{
	...
	public static extern uint MUI_NewObjectA(
		[M68kRegister(M68kRegister.A0)] uint className,
	...
	public static extern int MUI_RequestA(
		...
		[M68kRegister(M68kRegister.A0)] uint title,
		[M68kRegister(M68kRegister.A1)] uint gadgets,
		[M68kRegister(M68kRegister.A2)] uint format,
	...
	public static extern uint MUI_CreateCustomClass(
		...
		[M68kRegister(M68kRegister.A1)] uint superName,
	...
	public static extern int MUI_RequestObjectA(
		...
		[M68kRegister(M68kRegister.A3)] uint format,
		[M68kRegister(M68kRegister.A4)] uint parameters);

	public static uint MUI_NewObject(uint className, uint tags) =>
