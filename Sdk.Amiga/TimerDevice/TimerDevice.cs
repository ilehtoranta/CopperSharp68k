...
public static class TimerDevice
{
	...
	public const short AddTimeLvo = -42;
	public const short SubTimeLvo = -48;
	public const short CmpTimeLvo = -54;
	...
	public const short GetSysTimeLvo = -66;
	public const uint UnitEClock = (uint)TimerUnit.EClock;

	[AmigaLvo(AddTimeLvo)]
	public static extern void AddTime(
	...
	[AmigaLvo(SubTimeLvo)]
	public static extern void SubTime(
		[M68kRegister(M68kRegister.A6)] APTR deviceBase,
		[M68kRegister(M68kRegister.A0)] APTR destination,
		[M68kRegister(M68kRegister.A1)] APTR source);
	...
	public static extern int CmpTime(
		[M68kRegister(M68kRegister.A6)] APTR deviceBase,
		[M68kRegister(M68kRegister.A0)] APTR destination,
		[M68kRegister(M68kRegister.A1)] APTR source);
	...
	[AmigaLvo(GetSysTimeLvo)]
	public static extern void GetSysTime(
		[M68kRegister(M68kRegister.A6)] APTR deviceBase,
		[M68kRegister(M68kRegister.A0)] APTR destination);
}
